# nirdosh_asset_bundle
![CI](https://img.shields.io/badge/CI-GitHub_Actions-blue?logo=githubactions)
![Databricks](https://img.shields.io/badge/Platform-Databricks-orange)
![Deployment](https://img.shields.io/badge/Deployment-Asset_Bundles-green)
![Status](https://img.shields.io/badge/Status-Active-success)

The 'nirdosh_asset_bundle' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/nirdosh_asset_bundle/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] nirdosh_asset_bundle_etl` to your workspace.
